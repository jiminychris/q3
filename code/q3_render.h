...
inline void
PushTile(render_buffer *RenderBuffer, loaded_tile *Tile, u32 TileIndex)
{
    if(Tile)
    {
...
inline void
PushTiles(render_buffer *RenderBuffer, u32 Count, loaded_tile **Tiles)
{
    for(u32 TileIndex = 0;
        TileIndex < Count;
        ++TileIndex)
    {
        PushTile(RenderBuffer, Tiles[TileIndex], TileIndex);
    }
}
