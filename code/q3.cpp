...
#include "q3.h"
#include "q3_physics.cpp"
#include "q3_render.cpp"
#include "q3_play_mode.cpp"
#include "q3_title_screen_mode.cpp"

internal assets
LoadAssets(char *FileName, u32 Offset)
{
    assets Result = {};
    ...
    Result.TileCount = *((u32 *)ReadResult.Contents);
    Result.Tiles = (loaded_tile *)((u32 *)ReadResult.Contents + 1);
