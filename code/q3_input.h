...
internal void UnlatchGamePads(HWND Window);
internal void LatchGamePads(HWND Window);
internal void ProcessGamePadInput(game_input *OldController, game_input *NewController);
